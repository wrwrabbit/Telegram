...
import org.telegram.messenger.partisan.masked_ptg.loading.LoadingScreenFactory;

public class MaskedPtgConfig {
    private static IMaskedPasscodeScreenFactory FACTORY = new LoadingScreenFactory();
