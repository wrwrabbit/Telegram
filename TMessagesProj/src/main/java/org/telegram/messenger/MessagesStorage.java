...
//                        cursor = null;
    ...
    public void putMessages(ArrayList<TLRPC.Message> messages, boolean withTransaction, boolean useQueue, boolean doNotUpdateDialogDate, int downloadMask, boolean ifNoLastMessage, boolean scheduled, int threadMessageId) {
        ...
        if (useQueue) {
            storageQueue.postRunnable(() -> putMessagesInternal(filteredMessages, withTransaction, doNotUpdateDialogDate, downloadMask, ifNoLastMessage, scheduled, threadMessageId));
        } else {
            putMessagesInternal(filteredMessages, withTransaction, doNotUpdateDialogDate, downloadMask, ifNoLastMessage, scheduled, threadMessageId);
        }
    }
