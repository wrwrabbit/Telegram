...
//        TLRPC.StickerSet stickerSet = messages_stickerSet.set;
    ...
    private void searchMessagesInChat(String query, long dialogId, long mergeDialogId, int guid, int direction, long replyMessageId, boolean internal, TLRPC.User user, TLRPC.Chat chat, boolean jumpToMessage, ReactionsLayoutInBubble.VisibleReaction reaction, int offset_id) {
