...
//        botButtonsLayoutParams.bottomMargin = fullscreen ? insets.bottom : 0;
    ...
    public void requestWebView(BaseFragment fragment, WebViewRequestProps props) {
        ...
        CharSequence title = UserObject.getUserName(userbot, currentAccount);
        try {
        ...
        if (userbot != null && userbot.isVerified() || userInfo != null && userInfo.user != null && userInfo.user.isVerified()) {
    ...
    private void openOptions() {
        ...
        o
            ...
            .addIf(false && userbot != null && userbot.bot_has_main_app, R.drawable.msg_home, LocaleController.getString(R.string.AddShortcut), () -> {
