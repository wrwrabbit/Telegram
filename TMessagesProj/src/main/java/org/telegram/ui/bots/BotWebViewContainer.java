            ...
            case "web_app_biometry_request_access": {
                ...
                if (!biometry.access_granted) {
                    ...
                    if (TextUtils.isEmpty(reason)) {
                        ...
                        alert.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotAllowBiometryMessage, UserObject.getUserName(botUser, currentAccount))));
                    } else {
                        alert.setTitle(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotAllowBiometryMessage, UserObject.getUserName(botUser, currentAccount))));
