                            ...
                            for (int b = 0; b < 2; b++) {
                                ...
                                for (int a = 0; a < arrayList.size(); a++) {
                                    ...
                                    if (chat != null) {
                                        ...
                                        if (canAddGroupsOnly || !allowBots && user.bot || !allowSelf && user.self || !allowGlobalResults && b == 1 && !user.contact || !filter(user) || FakePasscodeUtils.isHideChat(-chat.id, currentAccount)) {
                                            continue;
                                        }
